...
<p style="color: #000000;">Database</p>
<div class="row">
<div class="col-sm-4" id="totalBrands">
<div class="card">
<div class="card-body">
<h5 class="card-title">Total of Employee</h5>
...
<div class="card">
<div class="card-body">
<h5 class="card-title">Number of Catalog Item Name</h5>
<h2 class="card-text" style="text-align: center;">
<?php
...
<div class="card">
<div class="card-body">
<h5 class="card-title">Total SAP Company</h5>
<h2 class="card-text" style="text-align: center;">
<?php
...
<div class="card">
<div class="card-body">
<h5 class="card-title">Number of Requests till date</h5>
<h2 class="card-text" style="text-align: center;">
<?php
